...
<head>
  ...
  <?php
    ...
    if(isset($_POST['editConfirm'])) {
        $_SESSION['idmonan'] = $_POST['editConfirm'];
...
<div class="circle"><a href="AddDish.php"><span class="fa fa-plus"></span></a></div>

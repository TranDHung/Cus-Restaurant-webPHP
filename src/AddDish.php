...
<head>
  ...
  <style type="text/css" href = "style.css">
   ...
   <?php
    ...
    $infor = '';
    $object = [];
    if(isset($_POST['submit']) && isset($_POST['id']) && isset($_POST['ten']) && isset($_POST['gia']) && isset($_POST['anh'])&& isset($_POST['vitri'])) {
...
<body>
  <nav class="navbar navbar-expand-sm navbar-infor">
   <a href="indexManager.php" class="navbar-brand"><img src="Image/logo.png" class="float-left" width="195px" height="45px"></a>
    ...
    <div class="text-create">Thêm món ăn</div>
    ...
    <button class="create-btn" type="submit" name="submit">Thêm món ăn</button>

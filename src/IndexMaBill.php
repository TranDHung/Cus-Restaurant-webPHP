...
<body>
  ...
  <div class="row-header">
    ...
    <div class="cell">Nhân viên lập</div>
    <div class="cell">Tên khách</div>
    <div class="cell">Ngày Lập</div>
    <div class="cell">Thành tiền</div>
  ...
  <?php
    ...
    <div class="cell"><?= $row['nguoilap'] ?></div>
    <div class="cell"><?= $row['tenkhach'] ?></div>
    <div class="cell"><?= $row['ngaylap'] ?></div>
    <div class="cell"><?= $row['thanhtien'] ?></div>
    <div class="cell-icon"><button type="submit" style="background-color:white; border: none;" name="view" value="<?= $row['id'] ?>"><span class="fa fa-eye"></span></button></div>
...
<div class="circle"><a href="AddBill.php"><span class="fa fa-plus"></span></a></div>
